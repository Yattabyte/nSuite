...
**************************************************"
cmake -DSTATIC_ANALYSIS=OFF -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS} + " -fsanitize=address" -DCMAKE_EXE_LINKER_FLAGS=${CMAKE_EXE_LINKER_FLAGS} + " -fsanitize=undefined" -UCMAKE_CXX_CLANG_TIDY .
cmake --build . -- -j $(nproc)
